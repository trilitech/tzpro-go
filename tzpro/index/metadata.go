...
func (c *metaClient) Get(ctx context.Context, addr Address) (Metadata, error) {
	var resp Metadata
...
func (c *metaClient) Remove(ctx context.Context, addr Address) error {
